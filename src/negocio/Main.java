...
public class Main {
	...
	/**
	 * Imprime menu de opcoes do nosso sistema bancirio
	 */
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Lucas Cross", 31, "lucascross@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Arec Papouias", 34, "arecpapo@gmail.com", conta02.getId(), true);
